...
| 可转债 | 风险过滤后的多因子候选池 | 价格、强赎、评级、YTM、溢价率、基本面、剩余规模、候选资格分层 | 合格候选、弱观察、风险观察、排除清单、评分拆解、风险提示 |
...
- **可转债**：合格候选 Top、弱观察、风险观察、排除清单、评分拆解和质量提示；合格候选不足 10 只时不补足。
...
- 可转债强赎未明默认不能进入 Top 候选；`cbTop10` 兼容字段只包含合格候选，不从弱观察或风险观察补足。
- Wind 伪交易日和零成交量不进入指标。
- 合规否定语不会被文本安全错误替换。
