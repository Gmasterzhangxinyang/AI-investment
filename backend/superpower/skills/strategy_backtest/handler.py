...
def _summary(
    ...
    rows = [
        ...
        {"item": "ETF平均持仓天数", "value": avg_holding_days, "level": "INFO", "note": ""},
        {
            ...
            "level": "INFO",
            "note": "短期方向诊断：T日收盘信号，T+1开盘执行，只检查T+1开盘到收盘是否上涨",
        },
        {"item": "ETF历史建仓信号次日上涨比例", "value": buy_next_day_hit_rate, "level": "INFO", "note": "不构成收益承诺，也不是正式预测准确率"},
        {"item": "ETF历史建仓信号次日平均涨跌幅", "value": buy_next_day_avg_return, "level": "INFO", "note": "T+1开盘到收盘"},
        {
            "item": "ETF历史平仓提示次日样本数",
            "value": sell_next_day_count,
            "level": "INFO",
            "note": "短期方向诊断：仅统计模拟持仓中触发的平仓提示，只检查T+1开盘到收盘是否下跌",
        },
        {"item": "ETF历史平仓提示次日下跌比例", "value": sell_next_day_hit_rate, "level": "INFO", "note": "不构成收益承诺，也不是正式预测准确率"},
        {"item": "ETF历史平仓提示次日平均涨跌幅", "value": sell_next_day_avg_return, "level": "INFO", "note": "负数表示平仓后次日下跌"},
        {
            "item": "TL建仓候选信号次数",
